...
If you have problems installing node.js and/or other tools to build and run RMPA on your machine and you just want to download html/js/css files, you can find links for download on this page.
...
[RMPA 1.3.1](/blur-admin/downloads/blur-admin-1.3.1.zip)
[RMPA 1.2.0](/blur-admin/downloads/blur-admin-1.2.0.zip)
